              ...
              <div class="span12">
                <div class="span2">
                  <ul class="ver-inline-menu tabbable margin-bottom-10">
                    <li class="active"> <a data-toggle="tab" href="#users"> <i class="icon-cog"></i> Upload </a> <span class="after"></span> </li>
                    <li ><a data-toggle="tab" href="#product"><i class="icon-picture"></i> View </a></li>
                  </ul>
                </div>
