...
Note: This message is imperative for anyone ...&nbsp<a href="/users/newsdetail/11">Read More</a></p>
                ...
                <div class="middle">
                    <div class="newz_sec">
                        <div class="mid_new">
                            <div class="new_imga" >
                                <div id="registration" class="ic_container">
                                    <img src="/img/images/ctg_01.png" width="315" height="179" alt="Futsal Registration" />
                                    <div class="ic_caption">
                                        <p class="ic_category">Tournaments <span style="font-family:plane_crashregular">&</span> Registration</p>
                                        <p class="ic_text">
                                            Enter here to Register or get more Information on any Futsal World Cup Weekend tournaments.
                                            <br/>
                                            <a href="/users/tournamentbioandregistration">View Now</a>                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mid_new">
                            <div class="new_imga" >
                                <div id="latestnews" class="ic_container">
                                    <img src="img/images/ctg_02.png" width="315" height="179" alt="Latest News" />
                                    <div class="ic_caption">
                                        <p class="ic_category">Latest News</p>
                                        <p class="ic_text">
                                            The latest FWCW event updates and Futsal news from around the globe
                                            <br />
                                            <a href="/users/latestnews">View Now</a>                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="mid_new">
                            <div class="new_imga" >
                                <div id="gallary" class="ic_container">
                                    <img src="img/images/ctg_03.png" width="315" height="179" alt="Gallary" />
                                    <div class="ic_caption">
                                        <p class="ic_category">Gallery</p>

                                        <p class="ic_text">
                                            All the Pictures and Videos from the FWCW events and general Futsal related pictures and videos.<br />
                                            <a href="/users/gallery">View More</a>                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="newz_sec">   
                        <div class="mid_new">
                            <div class="new_imga">
                                <div  id="playerprofile" class="ic_container">
                                    <img src="img/images/ctg_04.png" width="315" height="179" alt="Player profile" />
                                    <div class="ic_caption">
                                        <p class="ic_category">Player Profiles</p>

                                        <p class="ic_text">
                                            Find your Player Profile and stats along with every other FWCW player.  Also see the Individual award winners of every tournament.<br/>
                                            <a href="/users/playerprofile">View More</a>                                        </p>
                                    </div>
                                </div>
                            </div>   
                        </div>
                        <div class="mid_new">
                            <div class="new_imga">
                                <div id="shop" class="ic_container">
                                    <img src="img/images/ctg_05.png" width="315" height="179" alt="eShop" />
                                    <div class="ic_caption">
                                        <p class="ic_category">Shop</p>

                                        <p class="ic_text">
                                           Our Shop will be open soon with all our latest Indoor & Outdoor gear.<br/>
                                            <a href="/eshop/eshop_items/shop">View Now</a>                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mid_new">
                            <div class="new_imga">
                                <div id="sponsor" class="ic_container">
                                    <img src="img/images/ctg_06.png" width="315" height="179" alt="Sponsor" />
                                    <div class="ic_caption">
                                        <p class="ic_category">PARTNER/CO-SPONSORS</p>

                                        <p class="ic_text">
                                            Click here for information on our Partner /Sponsors<br/>
                                            <a href="/users/sponsorpage">View Now</a>                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="newz_sec">
                        <div class="mid_soca">
                            <div class="mid_soc_icon"><a href="https://www.facebook.com/FutsalWorldCupWeekend/app_190322544333196" target="_blank"><img src="/img/images/socb_01.png" alt="Facebook" align="right"/></a></div>
                            <div class="mid_soctxt">Become a fan <span>on facebook</span></div>
                        </div>
                        <div class="mid_socb">
                            <div class="mid_soc_icon"><a href="https://twitter.com/FutsalWCW" target="_blank"><img src="/img/images/socb_02.png" alt="Twitter" align="left" /></a></div>
                            <div class="mid_soctxt">Follow us  <span>on Twitter</span></div>
                        </div>
                        <div class="mid_socc">
                            <div class="mid_soc_icon"><a href="http://www.youtube.com/channel/UCXKuw7f9eNOZKnPdzOOzWew" target="_blank"><img src="/img/images/socb_03.png" alt="You Tube" align="right" /></a></div>
                            <div class="mid_soctxt">Subscribe to us<span>on Youtube</span></div>
                        </div>
                    </div>
                </div>
